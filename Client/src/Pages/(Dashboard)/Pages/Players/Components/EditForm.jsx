...
function EditForm({ setShowEditForm, selectedPlayer }) {
    ...
    const handleSubmit = async () => {
        const promise = new Promise(async (resolve, reject) => {
            try {
                ...
                const response = await ApiUrl.put('/player/' + selectedPlayer.id, formData);
            ...
            <div className="absolute h-screen top-0 left-0 right-0 min-h-screen flex justify-center items-center bg-gray-100 bg-opacity-50 p-0  transition-transform ease-in duration-300 ">
                <div className="mx-auto max-w-md px-6 py-12  bg-white border-0 shadow-lg sm:rounded-3xl md:w-full w-[80%]">
                    <section className='flex justify-between items-center mb-8'>
                        <h1 className="text-2xl text-main    font-bold">Edit Player</h1>
                        <button onClick={() => setShowEditForm(false)}>Close</button>
                    </section>
                    <form id="form" onSubmit={handleSubmit}>
                        <div className="relative z-0 w-full mb-5">
                            <input onChange={handleInputChange} value={formData.name} type="text" name="name" placeholder=" " required className="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        ...
                        <div className="relative z-0 w-full mb-5">
                            <input onChange={handleAgeChange} type="text" name="age" value={formData.age} placeholder=" " required className="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        ...
                        <div className="relative z-0 w-full mb-5">
                            <input onChange={handleInputChange} value={formData.email} type="email" name="email" placeholder=" " className="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        ...
                        <div className="relative z-0 w-full mb-5">
                            <input onChange={handleInputChange} value={formData.phone_number} type="text" name="phone_number" placeholder=" " className="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                            <label htmlFor="phone_number" className="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Enter Phone number</label>
                        ...
                        <div className="relative z-0 w-full mb-5">
                            <select onChange={handleInputChange} name="team_id" placeholder="selet a team" className="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none z-1 focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                                ...
                                {
                                    teams.map((team) => (
                                        <option selected={formData.team_id === team.id} value={team.id}>{team.team_name}</option>
                                    ))
                                }
                            </select>
                        ...
                        <div className="flex flex-row space-x-4">
                            <div className="relative z-0 w-full mb-5">
                                <input onChange={handleInputChange} value={formData.country} type="text" name="country" placeholder=" " className="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                            ...
                            <div className="relative z-0 w-full">
                                <input onChange={handleInputChange} value={formData.city} type="text" name="city" placeholder="" className="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        ...
                        <div className="flex flex-row space-x-4">
                            <div className="relative z-0 w-full mb-5">
                                <input onChange={handleInputChange} value={formData.state} type="text" name="state" placeholder=" " className="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                            ...
                            <div className="relative z-0 w-full">
                                <input onChange={handleInputChange} value={formData.address} type="text" name="address" placeholder="" className="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
