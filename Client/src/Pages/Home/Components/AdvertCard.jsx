    ...
    return (
        <>
            <div className='w-full bg-[#DE4232] bg-opacity-10 flex justify-center items-center py-12 '>
                <div className='w-[50%] flex py-24 flex-col items-center text-center bg-main bg-opacity-80 rounded-xl'>
                    ...
                    <button className='bg-white text-main px-12 py-2 rounded-md mr-4 shadow-lg focus:ring-2 ring-main ring-opacity-30'>Explore</button>
                </div>
            </div>
        </>
    )
